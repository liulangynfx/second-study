...
<body>
    ${userName },<c:if test="${userName!=null }"><a href="${pageContext.request.contextPath }/logout.action">退出</a></c:if>
    <form name="itemsForm" action="${pageContext.request.contextPath }/items/listItems.action" method="post">
        ...
        <table width="100%" border=1>
            ...
            <tr>
                ...
                <input type="button" value="批量删除" onclick="deleteByIDBatch();" /></td>
            </tr>
        </table>
        商品列表：
        <table width="100%" border=1>
            ...
            <c:forEach items="${itemsList }" var="item">
                <tr>
                    ...
                    <td>${item.detail }</td>
                    <td><a href="${pageContext.request.contextPath }/items/getItem.action?id=${item.id}">修改</a></td>
...
<script type="text/javascript">
	...
	function deleteByIDBatch() {
		document.itemsForm.action="${pageContext.request.contextPath }/items/deleteItemBatch.action";
